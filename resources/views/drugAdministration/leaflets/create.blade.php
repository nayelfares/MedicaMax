...
<div class="card mb-3">
    <div class="card-body">
        ...
        <form method="POST"  action="{{ route('leaflet.store') }}" data-parsley-validate novalidate>
            {{  csrf_field() }}
            <div class="row">
            ...
            <div class="row">
               <div class="col-md-6 mb-3">
                    ...
                    <div>
                        <textarea type="text" id="en_leaflet"  name="en_leaflet" placeholder="Enter Leaflet English " class="form-control"></textarea>
                    </div>
                </div>
            ...
            <div class="col-md-6 mb-3">
                    ...
                    <div>
                        <textarea type="text" id="ar_leaflet"  name="ar_leaflet" placeholder="Enter Leaflet Arabic" class="form-control"></textarea>
                    </div>
                </div>
        </div>
