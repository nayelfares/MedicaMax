...
<div class="card mb-3">
    <div class="card-body">
        ...
        <form method="POST"  action="{{ route('composition.store') }}" data-parsley-validate novalidate>
            {{  csrf_field() }}


            <div class="form-group">
                <label for="en_name">Composition English Name<span class="text-danger">*</span></label>
                <input type="text" name="en_name" data-parsley-trigger="change" required placeholder="Enter english term" class="form-control" id="en_name"  >
            </div>

            <div class="form-group">
                <label for="ar_name">Composition Arabic Name</label>
                <input type="text" name="ar_name" data-parsley-trigger="change"  placeholder="Enter Arabic term" class="form-control" id="ar_name" >
            </div>
