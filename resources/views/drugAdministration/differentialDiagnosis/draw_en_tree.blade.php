        ...
        function autoChangeFontStyle(text_bold,text_italic,text_color,background_color,under_line,ar_size,en_size){
            $.ajax({
                ...
                success:function(res){
                    ...
                    var text_ ="<div><label   style='font-weight: "+text_bold+";font-style: "+text_italic+"; background-color:"+background_color+";color:"+text_color+";word-wrap: break-word;text-decoration:"+under_line+";font-weight: "+text_bold+";float:left;width:"+en_width+"px;text-align:left;font-size:"+en_size+"px;padding: 0.0ex ;margint-buttom:0.01ex;'>"+node.en_term+"</label><label dir='rtl' style='font-weight: "+text_bold+";font-style: "+text_italic+"; background-color:"+background_color+";color:"+text_color+";text-align:right;word-wrap: break-word;text-decoration:"+under_line+";font-weight: "+text_bold+";width:"+ar_width+"px;font-size:"+ar_size+"px;padding: 0.0ex ;margint-buttom:0.01ex;' >"+node.ar_term+"</label><label class="+type+" style='font-weight: "+text_bold+";font-style: "+text_italic+"; background-color:"+background_color+";color:"+text_color+";word-wrap: break-word;text-decoration:"+under_line+";font-weight: "+text_bold+";float:left; width:"+code_width+"px;font-size:"+en_size+"px;padding: 0.0ex ;' >"+new_code+"</label></div>";
