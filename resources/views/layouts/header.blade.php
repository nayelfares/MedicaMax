    ...
    <div class="headerbar">   
        ...
        <div class="headerbar-left">
            <a href="{{ url('home') }}" class="logo"><img alt="Logo" src="{{ asset("assets/images/logo.png") }}" type="text/javascript" /> <span>Medica Max</span></a>
        </div>
                    ...
                    <ul class="list-inline float-right mb-0">
                        ...
                        <li class="list-inline-item dropdown notif">
                            <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                <img src="{{ asset("assets/images/avatars/alaa.jpg") }}" type="text/javascript" alt="Profile image" class="avatar-rounded">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                ...
                                <!-- item-->
                                <a href="{{ asset('pro-profile.html') }}" class="dropdown-item notify-item">
