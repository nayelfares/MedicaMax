            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">                       
                <div class="card mb-3">
                    <div class="card-header">
                        <h3><i class="fa fa-file"></i> Import Quantity Compositions</h3>
                    </div> 
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('quantitycomposition.import') }}" files="true" enctype="multipart/form-data">
                        {{ csrf_field() }}
