...
<script <script src={{asset("/js/alaa/jquery.js")}}></script>
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <!-- Body -->
            <form  method="POST"  action="{{ route('unit.store') }}" data-parsley-validate novalidate>
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ar_name"  placeholder="Enter Arabic unit name" class="form-control" id="ar_name"  >
                </div>
                <div class="form-group">
