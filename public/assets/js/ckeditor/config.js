...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Print,NewPage,HiddenField,ImageButton,Button,Select,Textarea,TextField,Radio,Checkbox';
	    ...
	    config.filebrowserBrowseUrl= '/drug-administration/multi_media';
    config.filebrowserUploadUrl= '/drug-administration/multi_media';
	//...
    /* Filebrowser routes */
    // The location of an external file browser, that should be launched when "Browse Server" button is pressed.
//    config.filebrowserBrowseUrl = "/images_tree";
